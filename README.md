...
В команде три человека. Для каждого человека в команде есть оценки по трем навыкам - трудолюбие, сообразительность и настойчивость.

Вы хотите проверить, можно ли упорядочить этих людей (присвоить им числа от 1 до 3) таким образом, чтобы каждый следующий член команды был строго лучше предыдущего. То есть вы проверяете, можно ли сделать строгий рейтинг, где каждый член команды точно лучше предыдущего.

Человек x считается лучше, чем другой человек y, если x нет ни одной оценки меньше, чем y в любом из навыков и и есть хотя бы одна оценка выше чем y, по крайней мере, в одном навыке.

Определите, существует ли такое упорядочение.

Пример данных:

    var team_1 = ['1 2 3', '2 3 4', '2 3 5'];
    var team_2 = ['1 2 3', '2 3 4', '2 3 4'];
    var team_3 = ['5 6 5', '1 2 3', '2 3 4'];
...
Ответы можно выводить в консоль браузера. 
...
![alt tag](http://www.stanford-bogazici.com/img/projects/randomCircles/demo1.png)
